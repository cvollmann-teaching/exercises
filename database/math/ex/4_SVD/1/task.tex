...
% 	\item Determine the pseudoinverse $A^+$ of $A$ with the help of the SVD. 
 	\item Assume that $A$ is symmetric (thus $m=n$) and positive definite. What is the relation between its singular values and its eigenvalues? Use the SVD to find the inverse $A^{-1}$.% What is the pseudoinverse in this case?
